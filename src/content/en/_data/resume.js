module.exports = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Frontend web development",
        extra: [
          { label: "ed.com.au", href: "https://ed.com.au" },
          { label: "co-partnership.com", href: "http://co-partnership.com" },
          { label: "breakingthrough.moadoph.gov.au", href: "https://breakingthrough.moadoph.gov.au" },
          { label: "storyation.com", href: "https://storyation.com" },
          { label: "universitiesaustralia.edu.au", href: "https://universitiesaustralia.edu.au" },
          { label: "sportrition.com.au", href: "https://sportrition.com.au" }
        ]
      },
      {
        id: "massive",
      ...
      },
      {
        ...
        description: "Frontend web development. Functional Reactive Programming with ReactJS and BaconJS."
      },
      {
        id: "dpt",
        ...
        location: "Montreal, Canada",
        url: "http://dpt.co",
        description: "Frontend web development. HTML, CSS, JS (NodeJS, React, ThreeJS), PHP",
        extra: [
          {
            label: "toutgarni.com",
      ...
      },
      {
        ...
        description: "Fullstack web development. HTML, CSS, JS, PHP (Wordpress, Craft CMS, Laravel, Lumen)",
        extra: [
          {
      ...
      },
      {
        ...
        description: "Frontend web development",
        extra: [
          { label: "cliffordantonefoundation.org", href: "https://cliffordantonefoundation.org" },
          { label: "endlesssummerproductions.com", href: "https://endlesssummerproductions.com" }
        ]
      },
      {
        id: "tp1",
        ...
        url: "http://tp1.ca",
        description: "Frontend web development. Accessible, responsive websites. Wordpress, Drupal. Agile team."
      },
      {
        id: "lesite",
        ...
        location: "Montreal, Canada",
        url: "http://lesite.ca",
        description: "Frontend web development. E-commerce websites with Magento. Contest one-pager websites (custom framework, PHP/JS)."
      },
      {
        id: "bluesponge",
    ...
    items: [
      {
        ...
        title: "technical",
        lines: [
          "Proficient with most of the popular creative tools (Sketch, Photoshop, Illustrator, Audition, Premiere, etc.)",
          "Extensive knowledge of most web development tools (Webpack, Git, etc.), techniques (BEM, OOCSS, web accessibility, etc.) and libraries (React/Redux, ThreeJS, lodash, VueJS, etc.)",
          ...
          "Experience with most management tools and platforms (Jira, Basecamp, Asana, Notion, Slack, etc.)"
        ]
      },
      {
        id: "other",
